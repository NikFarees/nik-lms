...
import { Lesson, Chapter } from '../../../../../lib/generated/prisma/index';
...
export async function reorderLessons(
    ...
    try {
        ...
        // After updating the lessons, we need to revalidate the path
        // This ensures that the changes are reflected in the UI
...
export async function reorderChapters(
    ...
    try {
        ...
        // After updating the chapters, we need to revalidate the path
        // This ensures that the changes are reflected in the UI
        revalidatePath(`/admin/courses/${courseId}/edit`);
...
export async function deleteLesson({
    ...
    try {
        ...
        // This will leave us with the remaining lessons in the chapter
        const remainingLessons = lessons.filter((lesson) => lesson.id !== lessonId);

        // We need to update the position of the remaining lessons
        // to ensure they are in the correct order after deletion
        ...
        // Execute all updates in a transaction
        // This will ensure that all updates are applied atomically
